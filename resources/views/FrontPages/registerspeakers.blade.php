...
@section('body')
<form method="post" action="{{url('speakers/store')}}" role="form" class="contactForm py-5 container w-75 m-auto" enctype="multipart/form-data">
     @csrf
   ...
   @if($errors->any())
       ...
       <div class="form-group col-lg-12 col-md-12 col-sm-12">
         ...
         <input id="Job" type="text" class="form-control rounded" name="job" placeholder="" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
