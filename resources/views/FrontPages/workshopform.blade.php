...
<button id="btnUp" class="rounded-circle  p-2 text-white change" style="background-color: #a83341;">
  <i class="fa fa-chevron-up"></i>
          ...
          <form class=" col-lg-12 col-md-12 col-sm-12 w-75 m-auto" method="post" action="{{url('/workshops.store')}}" role="form" class="contactForm py-5 container">
            @csrf 
            ...
            @endif
              ...
              <div class="form-group col-lg-12 col-md-12 col-sm-12">
                ...
                <textarea class="form-control rounded" name="Attend" rows="5" data-rule="required" data-msg="Please write something for us" placeholder=""></textarea>
              ...
              <div class="form-row ">
                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                  ...
                  <textarea class="form-control rounded" name="Experience" rows="5" data-rule="required" data-msg="Please write something for us" placeholder=""></textarea>
                  <div class="validation"></div>
                </div>
                </div>
