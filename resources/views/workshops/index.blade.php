...
<div class="container">
   ...
   <div class="jumbotron text-light" style="background-color: #101d3d;">
      <h1 class="display-4"style="color:#e8465a;padding-top:50px;">Workshops Data</h1>
   </div>
   ...
   <table class="table table-Secondary table-bordered table-hover">
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <div class="row">
                  <div class="col-3"><a href="{{ route('workshop.show', $item) }}" class="btn btn-success"> view</a></div>
